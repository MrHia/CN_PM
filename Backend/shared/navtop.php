...
<nav class="navbar navbar-light bg-light">
  ...
  <a class="navbar-brand" id="top-logo" href="/trotot/index.php">
    ...
    <form class="d-flex"  action="Backend/process/login_submit.php">
        <?php 
         if(!isset($_SESSION["user"])){
            ...
            EOD;
            echo $my_var = <<<EOD
                <button type="submit" name = "login_submit" class="btn btn-primary btn-lg btn-block btn-navtop ">Đăng nhập</button>
            EOD;
        }
            else{
                echo $my_var = <<<EOD
                <button  class="btn btn-primary btn-lg btn-block btn-navtop ">Quản lý tài khoản</button>
                EOD;
                echo $my_var = <<<EOD
                <button  class="btn btn-primary btn-lg btn-block btn-navtop">Đăng tin mới</button>
                EOD;
