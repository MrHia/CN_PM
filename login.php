...
<section class="vh-100">
  <div class="container py-5 h-100">
    <div class="row d-flex align-items-center justify-content-center h-100">
        ...
        <!-- /Backend/process/ -->
        <form action="Backend/process/login_submit.php" method="POST">
            <h1>Đăng nhập</h1>
            <p>
              <?php
          ...
          <div class ="justify-content-center">
            <button type="submit" name = "register_submit" class="btn btn-primary btn-lg btn-block">Đăng nhập</button>
            <button type="reset" class="btn btn-primary btn-lg btn-block ">Làm mới</button>
          </div>
          <BR>
          <a class = "mt-5" href="register.php">Bạn chưa có tài khoản? hãy đăng ký ngay</a>
        </form>
        </div>
